...
public class ExtendedInvoiceLineServiceImpl extends InvoiceLineProjectServiceImpl
    implements InvoiceLineService {

  @Inject
  public ExtendedInvoiceLineServiceImpl(
      final CurrencyService currencyService,
      final PriceListService priceListService,
      final AppAccountService appAccountService,
      ...
      final ProductCompanyService productCompanyService) {
    super(
        currencyService,
        priceListService,
        appAccountService,
  ...
  public Map<String, Object> getDiscountsFromPriceLists(
      final Invoice invoice, final InvoiceLine invoiceLine, final BigDecimal price) {
  ...
  public Map<String, Object> getDiscount(
    ...
    final Map<String, Object> rawDiscounts =
        this.getDiscountsFromPriceLists(invoice, invoiceLine, price);
    if (rawDiscounts != null) {
      processedDiscounts.put(
          "discountTypeSelect", rawDiscounts.get(PriceListConstants.LINE_DISCOUNT_TYPE_SELECT));
      processedDiscounts.put(
          "discountAmount", rawDiscounts.get(PriceListConstants.LINE_DISCOUNT_AMOUNT));
      processedDiscounts.put(
          "secDiscountTypeSelect",
          rawDiscounts.get(PriceListConstants.LINE_SECOND_DISCOUNT_TYPE_SELECT));
      processedDiscounts.put(
          "secDiscountAmount", rawDiscounts.get(PriceListConstants.LINE_SECOND_DISCOUNT_AMOUNT));
    }
